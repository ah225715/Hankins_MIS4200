...
namespace Hankins_MIS4200.Controllers
{
    public class PlanesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "planeId,planeName,airline,dateManufactured")] Plane plane)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "planeId,planeName,airline,dateManufactured")] Plane plane)
        {
            if (ModelState.IsValid)
            {
